"""
Kalyan College Fee Structure (Legacy 2024).
...
# ─── Fee Structure: Installment-based ─────────────────────
# Format: course_key -> {
#   first: {various, tuition, practical, total},
#   second: {various, tuition, practical, total},
#   year_total
# }
...
_FEE_INSTALLMENTS_BASE = {
    ...
    # M.Sc. Bot/Che/Maths/Phy/Zoo group
    "M.Sc. (Botany - Previous)": {
...
_FEE_HEADS_DETAIL_BASE = {
    ...
    # PG courses (using "MA" key for both Previous and Final)
    "M.A.": {
        "Admission Fees": 500, "Amalgamated Fund": 100, "Library Development": 500,
        "Home Examination": 200, "Establishment Fund": 1000, "Student Development": 250,
...
def get_fee_structure(course_name: str) -> dict | None:
    ...
    # Map specific PG courses to their group key
